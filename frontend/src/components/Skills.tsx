...
export default function Skills() {
  ...
  return (
    <section id="skills" ref={ref} className="py-8 md:py-20 bg-black relative overflow-hidden">
       {/* Background glow */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <motion.h2 
          ...
          viewport={{ once: true }}
          className="text-4xl font-bold mb-6 md:mb-20 text-center text-white"
        >
          TECHNICAL ARSENAL
        </motion.h2>

        {/* Added padding-left to shift content slightly right */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 h-full pl-0 md:pl-12">
           ...
           >
              <p className="text-dark-silver text-base md:text-lg leading-relaxed mb-4 md:mb-6">
              ...
              <p className="text-dark-silver text-base md:text-lg leading-relaxed">
                I also have experience with cloud infrastructure (AWS), containerization (Docker), and database management (MongoDB, SQL).
              </p>
           </motion.div>

           {/* 3D Cloud - Right Side */}
           <div className="w-full md:w-2/3 h-[350px] md:h-[500px] order-1 md:order-2 flex items-center justify-center translate-x-0 md:translate-x-8">
